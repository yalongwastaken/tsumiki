...
Status of every finding, verified against the code and `docs/CHANGELOG.md` (Unreleased section):
...
| ✅ Fixed 2026-07-13 | **H5** (NetWorthCard hidden once accounts exist), **H6** ("Deleted — Undo" toast restores a deleted transaction), **M11** (SW prunes assets the current index.html doesn't reference), **L6** (app-lock form validates the server's 8-char minimum), **L11** (SW only caches a 2xx shell)                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| ❌ Open             | **M8**/**M9** (offline read/write resilience), **M10** (setup-editor deletes lack confirm/undo), **L7–L10**, **L12–L14**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
Remaining open items are offline-resilience work (M8/M9), shared confirm-or-undo across the setup editors (M10), and the low-priority polish list.
