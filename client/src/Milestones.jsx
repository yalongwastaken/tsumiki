...
export default function Milestones({ list }) {
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-4">
      <div className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-3">Milestones</div>
      ...
      {achieved.length > 0 ? (
        ...
        <div className="text-sm text-slate-400 mb-3">No milestones yet — your first contribution starts it.</div>
      )}
